...
class _wishlistState extends State<wishlist> {
          ...
          children: [
            ...
            Padding(
                ...
                child: GestureDetector(
                    ...
                    child: isImage
                        ? Image.asset(
                            'assets/images/img_47.png',
                            height: 24,
                          )
                        : Image.asset(
                            'assets/images/closeheart.png',
                            width: 24,
                            color: Colors.black,
                          )))
          ],
  ...
  Future<void> apiCall() async {
    userModel = await ApiMethods.userData1(user_id: '1', tour_id: '1');
